...
function convertInner(api, options, callback) {
    ...
    console.log(options.splitOutPath);
...
function createSplitContent(templates, header, data, options, callback) {
    ...
    let customerResources = createContent('customer-resources', templates, header, data, options, callback, options.omitHeader);

    let hackerResources = createContent('hacker-resources', templates, header, data, options, callback, options.omitHeader);

    let reference = createContent('reference', templates, header, data, options, callback, true);

    return [customerResources, hackerResources, reference];
}
