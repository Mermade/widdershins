    ...
    for (let reqBodyExample in requestBody.content) {
        for (let ct in requestBody.content) {
            ...
            if (contentType.examples) {
                ...
                examples.push({description:reqBodyExample+' '+data.translations.requestBody,value:common.getSample(obj,data.options,{skipWriteOnly:true},data.api), cta: cta, xmlWrap: xmlWrap});
            }
        }
    }
    let lastDesc = '';
