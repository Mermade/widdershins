...
function createSplitContent(templates, header, data, options, callback) {
    ...
    let resources = createContent(`${sectionName}-resources`, templates, header, data, options, callback, options.omitHeader);

    let reference = createContent(`${sectionName}-reference`, templates, header, data, options, callback, true);
