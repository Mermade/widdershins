...
function convert(api, options, callback) {
    if (options.resolve) {
        swagger2openapi.convertObj(api, {resolve:true,source:options.source,verbose:options.verbose, rbname: options.useBodyName ? 'x-body-name' : ''}, function(err, sOptions) {
        if (err) {
